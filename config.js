...
module.exports = {
	...
	AUDIO_DATA: process.env.AUDIO_DATA || "𝐙𝐞𝐭𝐫𝐨 𝐃𝐞𝐯𝐢𝐥;𝐙𝐞𝐭𝐫𝐨 𝐃𝐞𝐯𝐢𝐥;https://files.catbox.moe/925dls.jpg",
	AUTO_STATUS_VIEW: toBool(process.env.AUTO_STATUS_VIEW || "true"),
	BOT_INFO: process.env.BOT_INFO || "𝐙𝐞𝐭𝐫𝐨 𝐃𝐞𝐯𝐢𝐥;https://files.catbox.moe/925dls.jpg",
	...
	SUDO: process.env.SUDO || "9188911 31521",
